...
VARIABLES = {
    ...
    "晶体尺寸/厚度": {
        "mechanism": "尺寸增加可能放大温度/浓度梯度和内部应力尺度。",
        "experiment": "相同流程下比较不同目标尺寸/厚度。",
        "metric": "尺寸-开裂概率、裂纹长度、温度梯度估计",
        "query": "crystal size thermal stress crack KDP",
        "falsify": "在足够尺寸跨度下开裂概率与尺寸无趋势，则尺寸效应不是主要因素。",
        "record": "记录三维尺寸、质量、生长时间与裂纹统计。",
    },
    "包裹体/散射点": {
